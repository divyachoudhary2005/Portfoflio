...
function openGmail() {
  const email = "choudharydivya200515@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Divya Choudhary Resume.pdf"; // Path to your resume file
  link.download = "Divya Choudhar Resume"; // Name for the downloaded file
